...
//console.log(config.imports.geonames.unwantedFeatureCode);
if (Array.isArray(config.imports.geonames.unwantedFeatureCode) && config.imports.geonames.unwantedFeatureCode !== []) {
  var unwantedFcodes = config.imports.geonames.unwantedFeatureCode;
}
else {
  var unwantedFcodes = [
